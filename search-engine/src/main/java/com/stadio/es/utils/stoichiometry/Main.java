...
//		Reaction.fromString("KOH(s) + CO2(g) → K2CO3(s) + H2O(l)").setGrams("KOH(s)", 367).printInfo();
		Reaction.fromString("H2SO4 + Na2CO3(aq) → CO2(g) + H2O(l) + Na2SO4(aq) ").setMoles("H2SO4", 1).printInfo();
...
//		Reaction.fromString("N2+H2→NH3").printInfo();
