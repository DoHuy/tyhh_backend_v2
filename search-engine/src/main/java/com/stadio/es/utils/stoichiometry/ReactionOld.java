...
//		System.out.println("Unsolved	" + reactants + " => " + products);
		...
		for (Entry<Compound, Double> entry : all.entrySet()){
...
//    	System.out.println(lowestCommonDenominator);
        ...
        Iterator<Entry<Compound, Double>> it2 = reactants.entrySet().iterator();
        Iterator<Entry<Compound, Double>> it3 = products.entrySet().iterator();
