...
public class ResponseResult<DTO>
{
    ...
    public static<DTO> ResponseResult newSuccessInstance()
    {
        return new ResponseResult<>("00", "SUCCESS", null);
    }
    ...
    public static ResponseResult newErrorDefaultInstance(String msg)
    {
        return newInstance(ResponseCode.FAIL, msg, null);
    }
